...
def func():
    stdout.write("LAYER 7 \n")
    stdout.write("spoof        -spoof X-forward attack with socks5\n")
    stdout.write("cfb        -Bypass CF attack\n")
    stdout.write("pxcfb      -Bypass CF attack with proxy\n")
    stdout.write("cfpro      -Bypass CF UAM, CF CAPTCHA, CF BFM, CF JS (request)\n")
    stdout.write("cfsoc      -Bypass CF UAM, CF CAPTCHA, CF BFM, CF JS (socket)\n")
    stdout.write("sky        -HTTPS Flood and bypass for CF NoSec, DDoS Guard Free and vShield with sock5\n")
    stdout.write("stellar    -HTTPS Sky method without proxies\n")
    stdout.write("bypass     -HTTPS method without proxies  bypass Google Shield, VShield\n")
    stdout.write("raw        -Request attack\n")
    stdout.write("post       -Post Request attack\n")
    stdout.write("head       -Head Request attack\n")
    stdout.write("soc        -Socket attack\n")
    stdout.write("hulk       -HULK - HTTP Unbearable Load King\n")
    stdout.write("pxhulk     -proxyHULK HTTP Unbearable Load King\n")
    stdout.write("pxraw      -Proxy Request attack\n")
    stdout.write("pxsoc      -Proxy Socket attack\n")
    stdout.write("pxslow     -Proxy Slowloris attack\n")
    stdout.write("http2     -HTTP/2.0 Flood\n")
    stdout.write("slowread        -Slowread dos.Slowhttptest\n")
    stdout.write("tcp        -Strong TCP attack (not supported)\n")
    stdout.write("udp        -Strong UDP attack (not supported)\n")
    stdout.write("mine        -minecraft disconnect login DOS (not supported)\n")
    stdout.write("vse        -Send Valve Source Engine Protocol\n")
    stdout.write("dns        -Classic DNS Lookup\n")
    stdout.write("geoip      -Geo IP Address Lookup\n")
    stdout.write("subnet     -Subnet IP Address Lookup\n")
    stdout.write("clear/cls  -Clear console\n")
    stdout.write("exit       -Bye..\n")
    stdout.write("credit     -Thanks for\n")
